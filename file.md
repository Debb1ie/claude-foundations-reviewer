...
![ANTHROP\C](outputs\file_image_1_12.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Integrating Claude into **CI/CD pipelines** for automated code review, test generation, and
...
![ANTHROP\C](outputs\file_image_2_13.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ **Domain 3: Claude Code Configuration & Workflows** (20% of scored content)
...
![ANTHROP\C](outputs\file_image_3_16.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>###### Scenario 4: Developer Productivity with Claude
...
![ANTHROP\C](outputs\file_image_4_13.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ The agentic loop lifecycle: sending requests to Claude, inspecting stop_reason
...
![ANTHROP\C](outputs\file_image_5_18.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Partitioning research scope across subagents to minimize duplication (e.g., assigning
...
![ANTHROP\C](outputs\file_image_6_20.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ The difference between programmatic enforcement (hooks, prerequisite gates) and
...
![ANTHROP\C](outputs\file_image_7_17.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Choosing hooks over prompt-based enforcement when business rules require guaranteed
compliance
...
![ANTHROP\C](outputs\file_image_8_17.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Using --resume with session names to continue named investigation sessions across
work sessions
...
![ANTHROP\C](outputs\file_image_9_22.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Reviewing system prompts for keyword-sensitive instructions that might override
...
![ANTHROP\C](outputs\file_image_10_20.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ tool_choice configuration options: "auto" , "any" , and forced tool selection ( {"type":
...
![ANTHROP\C](outputs\file_image_11_21.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Choosing existing community MCP servers over custom implementations for standard
...
![ANTHROP\C](outputs\file_image_12_21.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ The CLAUDE.md configuration hierarchy: user-level ( ~/.claude/CLAUDE.md ),
...
![ANTHROP\C](outputs\file_image_13_21.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Creating project-scoped slash commands in .claude/commands/ for team-wide
...
![ANTHROP\C](outputs\file_image_14_21.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Plan mode enables safe codebase exploration and design before committing to changes,
...
![ANTHROP\C](outputs\file_image_15_17.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Using the interview pattern to surface design considerations (e.g., cache invalidation
...
![ANTHROP\C](outputs\file_image_16_17.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>###### Domain 4: Prompt Engineering & Structured Output
...
![ANTHROP\C](outputs\file_image_17_19.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Creating 2-4 targeted few-shot examples for ambiguous scenarios that show reasoning for
...
![ANTHROP\C](outputs\file_image_18_20.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Adding enum values like "unclear" for ambiguous cases and "other" + detail fields for
...
![ANTHROP\C](outputs\file_image_19_19.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Batch processing is appropriate for non-blocking, latency-tolerant workloads (overnight
...
![ANTHROP\C](outputs\file_image_20_17.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>###### Domain 5: Context Management & Reliability
...
![ANTHROP\C](outputs\file_image_21_18.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Appropriate escalation triggers: customer requests for a human, policy exceptions/gaps
...
![ANTHROP\C](outputs\file_image_22_18.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Returning structured error context including failure type, what was attempted, partial
...
![ANTHROP\C](outputs\file_image_23_19.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ The risk that aggregate accuracy metrics (e.g., 97% overall) may mask poor performance
...
![ANTHROP\C](outputs\file_image_24_18.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Structuring reports with explicit sections distinguishing well-established findings from
...
![ANTHROP\C](outputs\file_image_25_16.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>**Question 2:** Production logs show the agent frequently calls get_customer when users ask
...
![ANTHROP\C](outputs\file_image_26_7.png)
...
![ANTHROP\C](outputs\file_image_27_11.png)
...
![ANTHROP\C](outputs\file_image_28_6.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>Option A is correct because .claude/rules/ with glob patterns (e.g., **/*.test.tsx ) allows
...
![ANTHROP\C](outputs\file_image_29_7.png)
...
![ANTHROP\C](outputs\file_image_30_4.png)
...
![ANTHROP\C](outputs\file_image_31_13.png)
...
![ANTHROP\C](outputs\file_image_32_3.png)
...
1. ​ Implement an agentic loop that checks stop_reason to determine whether to continue
tool execution or present the final response. Handle both "tool_use" and "end_turn"
stop reasons correctly.

1. ​ Add structured error responses to your tools: include errorCategory
(transient/validation/permission), isRetryable boolean, and human-readable
...
1. ​ Implement a programmatic hook that intercepts tool calls to enforce a business rule (e.g.,
blocking operations above a threshold amount), redirecting to an escalation workflow
when triggered.

1. ​ Test with multi-concern messages (e.g., requests involving multiple issues) and verify the
...
![ANTHROP\C](outputs\file_image_33_18.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>###### Exercise 2: Configure Claude Code for a Team Development Workflow
...
1. ​ Create .claude/rules/ files with YAML frontmatter glob patterns for different code
...
1. ​ Create a project-scoped skill in .claude/skills/ with context: fork and
allowed-tools restrictions. Verify the skill runs in isolation without polluting the main
conversation context.

1. ​ Configure an MCP server in .mcp.json with environment variable expansion for
credentials. Add a personal experimental MCP server in ~/.claude.json and verify both
are available simultaneously.

1. ​ Test plan mode versus direct execution on tasks of varying complexity: a single-file bug
...
![ANTHROP\C](outputs\file_image_34_19.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>
1. ​ Implement a validation-retry loop: when Pydantic or JSON schema validation fails, send a
...
1. ​ Add few-shot examples demonstrating extraction from documents with varied formats
...
1. ​ Design a batch processing strategy: submit a batch of 100 documents using the Message
...
1. ​ Implement a human review routing strategy: have the model output field-level confidence
...
1. ​ Implement parallel subagent execution by having the coordinator emit multiple Task tool
calls in a single response. Measure the latency improvement compared to sequential
execution.

1. ​ Design structured output for subagents that separates content from metadata: each
...
![ANTHROP\C](outputs\file_image_35_19.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>
1. ​ Implement error propagation: simulate a subagent timeout and verify the coordinator
...
1. ​ Test with conflicting source data (e.g., two credible sources with different statistics) and
...
![ANTHROP\C](outputs\file_image_36_23.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ **Message Batches API** — 50% cost savings, up to 24-hour processing window, custom_id
...
![ANTHROP\C](outputs\file_image_37_21.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ **CLAUDE.md configuration** : Hierarchy (user/project/directory), @import patterns,
...
![ANTHROP\C](outputs\file_image_38_29.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>-​ Specific cloud provider configurations (AWS, GCP, Azure)
...
1. ​ **Configure Claude Code for a real project** : Set up CLAUDE.md with a configuration
...
1. ​ **Design and test MCP tools** : Write tool descriptions that clearly differentiate similar tools.
...
1. ​ **Build a structured data extraction pipeline** : Use tool_use with JSON schemas, implement
...
1. ​ **Practice prompt engineering techniques** : Write few-shot examples for ambiguous
...
1. ​ **Study context management patterns** : Practice extracting structured facts from verbose
tool outputs, implementing scratchpad files for long sessions, and designing subagent
delegation to manage context limits.

1. ​ **Review escalation and human-in-the-loop patterns** : Understand when to escalate (policy
...
![ANTHROP\C](outputs\file_image_39_23.png)

<||WXb23TXrUn3Rxz00yNNr89HV||>
1. ​ **Complete the Practice Exam** : Before sitting for the real exam, complete the practice exam
...
![ANTHROP\C](outputs\file_image_40_5.png)
